...
### FASE 1: Renderizar Lista Básica (AHORA)
- [ ] Renderizar tareas desde `seedTasks`
- [ ] Crear componente `Task.jsx` individual
- [ ] Mostrar título, estado (completada/pendiente)
- [ ] Agregar identificadores visuales

### FASE 2: Agregar Interactividad
- [ ] Implementar `useState` para estado interno
- [ ] Botón para marcar completada
- [ ] Botón para eliminar tarea
- [ ] Contador de tareas pendientes

### FASE 3: Agregar Tarea Nueva
- [ ] Crear componente `TaskForm.jsx`
...
**Lo que sigue:**
1. Renderizar tareas en `TaskList.jsx`
2. Crear componente `Task.jsx`
3. Agregar interactividad
4. Implementar formula para agregar tareas
